...
Then run::
    ...
    INFRAHUB_ADDRESS=http://localhost:18000 uv run pytest tests/integration -m integration
...
- ``INFRAHUB_ADDRESS``    — default: the intent client default (http://localhost:18000)
